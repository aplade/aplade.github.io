...
It is worth noting that yields $$(\\textbf{y})$$ are annually compounded as we use the German Fixed Rate Bonds method in which yields are compounded on the same frequency as the coupon frequency.
